/* =========================================================================
   ...
   - FEATURES:
     0. 🔥 NEW: FIREBASE CLOUD DATA FETCHING + PRO/FREE LOGIC (MK_EDITOR66 ADDED)
        ...
        <div id="unlock-badge-modal" class="qms-modal-overlay" style="z-index: 100005;">
            <div class="qms-modal-box" style="background: radial-gradient(circle, #2a2a35 0%, #0f0f19 100%); border: 2px solid #ffc107; text-align: center; padding: 3rem 2rem; overflow: hidden; position: relative;">
                ...
                <div style="position: relative; z-index: 2;">
                    ...
                    <button id="claim-badge-btn" class="btn-primary-glow sfx-trigger" style="background: #ffc107; color: #000; padding: 10px 25px; border:none; border-radius: 8px; font-weight: bold; cursor: pointer;">प्राप्त करें (Claim)</button>
                </div>
            </div>
        </div>
    `;
